...
CTimerEx::CTimerEx(CEventEngine *lpEngine, CWeakPtr<ITimerEventEx> wpTimerEventEx) : CEvent(lpEngine)
{
	Assert(wpTimerEventEx.Lock() != NULL);
...
void CTimerEx::OnRead()
{
	...
	CSharedPtr<ITimerEventEx> spTimerEvent = m_wpTimerEvent.Lock();
