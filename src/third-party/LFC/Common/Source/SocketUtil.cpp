...
Int32 SocketUtil::GetRecvBufferSize(Int32 nFD)
{
    socklen_t nLen = sizeof(Int32);
    Int32 nSize = 0;
    if (-1 == getsockopt(nFD, SOL_SOCKET, SO_RCVBUF, &nSize, &nLen))
    {
        nSize = -1;
    }
...
Int32 SocketUtil::GetSendBufferSize(Int32 nFD)
{
    socklen_t nLen = sizeof(Int32);
    Int32 nSize = 0;
    if (-1 == getsockopt(nFD, SOL_SOCKET, SO_SNDBUF, &nSize, &nLen))
    {
        nSize = -1;
    }
...
Bool SocketUtil::SetRecvBufferSize(Int32 nFD, Int32 nSize)
{
    return (setsockopt(nFD, SOL_SOCKET, SO_RCVBUF, &nSize, sizeof(Int32)) != -1);
}

Bool SocketUtil::SetSendBufferSize(Int32 nFD, Int32 nSize)
{
    return (setsockopt(nFD, SOL_SOCKET, SO_SNDBUF, &nSize, sizeof(Int32)) != -1);
}
